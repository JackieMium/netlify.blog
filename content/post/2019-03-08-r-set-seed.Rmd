...
好吧，废话不多数，主要参考的就是 R 本身的文档和 StackOverflow 的一个问题：[R set.seed() 's scope](https://stackoverflow.com/questions/25513204/r-set-seed-s-scope)。
...
![](/post/2019-03-08-r-set-seed_files/1.setseed.png)
...
![](/post/2019-03-08-r-set-seed_files/2.rmseed.png)

```{r rmseed, collapse=TRUE}
set.seed(100)
rnorm(1)
rnorm(1)
rnorm(1)
